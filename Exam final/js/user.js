    ...
    var accountTwoMoney = parseInt(localStorage.getItem('AccountTwoMoney'));
    alert(accountTwoMoney);
    //localStorage.removeItem('AccountOneMoney');

    if (isNaN(accountTwoMoney)) {
        accountTwoMoney = 0;
    }

    var checkingBalance = 1000 + accountTwoMoney;
    var savingBalance = 1000;
    var finalBalance = checkingBalance;
    //var currentBalance = 2000;
    var currentBalance = checkingBalance+accountTwoMoney;
    ...
    if ((fromAccount.match("saving")) && (toAccount.match("checking"))) {
       ...
       //setCheckingBalance();
        ...
        if (tempAmount > checkingBalance) {
            ...
            localStorage.setItem('AccountOneMoney',otherAccoutBalance);
...
function addDataToTableIn() {
    ...
    event.preventDefault();
     ...
     dateTd.textContent   = date;
     outTd.textContent = "";
     inTd.textContent = accountTwoMoney;
     balanceTd.textContent    = checkingBalance;
